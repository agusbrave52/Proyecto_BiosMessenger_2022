<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageUsuario.master" AutoEventWireup="true" CodeFile="BandejaDeEntrada.aspx.cs" Inherits="BandejaEntrada" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Label ID="Label7" runat="server" Text="Seleccionar Fecha:"></asp:Label>
        ...
        <tr>
            <td class="estilo1">
    <asp:GridView ID="gvEntrada" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="gvEntrada_SelectedIndexChanged" Width="461px">
        <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
        <Columns>
            <asp:BoundField HeaderText="Fecha" DataField="Fecha" />
            <asp:BoundField HeaderText="Asunto" DataField="Asunto" />
            <asp:BoundField HeaderText="Remitente" DataField="UsuariosEnv.NombreUsuario" />
